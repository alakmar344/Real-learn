    ...
    >
      ...
      <section style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 14, color: "var(--text-secondary)" }}>
          ...
          Qwen 3.6 27B and GPT-OSS 120B on LPUs); if Groq is temporarily slow or unavailable, the same request
          automatically falls back to <strong>NVIDIA NIM</strong> (70B–150B parameter models), and may then use
      ...
      <section style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 14, color: "var(--text-secondary)" }}>
          ...
          Groq Cloud, NVIDIA NIM, or Cloudflare Workers AI) at any time without notice or
