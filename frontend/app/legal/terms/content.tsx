  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: 13, color: "var(--text-tertiary)", marginBottom: 24 }}>
        Last updated: August 10, 2026 (version 3.0)
      </p>
      ...
      <section style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 14, color: "var(--text-secondary)" }}>
          ...
          recently been asked. The service also includes the &quot;Find&quot; feature, which builds a
          personalized map of the concepts you have proven you know (by passing lesson quizzes),
          computed on your device, and recommends what to learn next; its optional &quot;discover
          related lessons&quot; search sends only short topic labels and your goal text to search our
          shared, anonymous lesson cache and is not stored or linked to you (see the Privacy Policy).
          Recommendations are suggestions only and are provided &quot;as is&quot; without any
