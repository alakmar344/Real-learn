    ...
    >
      ...
      <section style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 14, color: "var(--text-secondary)" }}>
          ...
          Fast and Explain modes) are generated by Google&apos;s Gemma 4 open model. Our{" "}
          <strong>primary</strong> inference provider is <strong>Cerebras Cloud</strong> (running
          Gemma 4 31B); if Cerebras is temporarily slow or unavailable, the same request
          automatically falls back to <strong>NVIDIA NIM</strong> (Gemma 4 31B), and may then use
          <strong>Cloudflare Workers AI</strong> (Gemma) as a last-resort provider so the lesson can
