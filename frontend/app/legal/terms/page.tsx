  ...
  return (
    ...
    >
      ...
      <section style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 14, color: "var(--text-secondary)" }}>
          <strong>Important:</strong> You are interacting with an AI system. The information
          provided by RealLearn is generated by artificial intelligence and may be inaccurate,
          incomplete, or outdated. RealLearn does not guarantee the accuracy, reliability, or
          completeness of any AI-generated content. The content is for educational purposes only
          and should not be considered professional advice (medical, legal, financial, etc.).
          Always verify important information with qualified professionals or authoritative sources.
        </p>
      </section>
      ...
      <section style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 14, color: "var(--text-secondary)" }}>
          We employ automated content filtering and human review processes to ensure the Service
          remains safe and appropriate for all users. We reserve the right to remove or restrict
          access to content that violates our community guidelines or these Terms. We also maintain
          guardrails to prevent the AI from generating harmful, illegal, or age-inappropriate content.
        </p>
      </section>
      ...
      <section>
        ...
        <p style={{ fontSize: 14, color: "var(--text-secondary)" }}>
          If you have any questions about these Terms of Service, please contact us at our website:{" "}
          <a
      ...
      <section style={{ marginTop: 28 }}>
        ...
        <p style={{ fontSize: 14, color: "var(--text-secondary)" }}>
          RealLearn, the RealLearn logo, and all related names, logos, and slogans are trademarks
          of RealLearn. All content generated by the Service is the property of the user who
          requested it, subject to our limited license to display it as part of the Service.
