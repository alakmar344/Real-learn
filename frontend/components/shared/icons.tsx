...
// Single inline-SVG icon set for the whole app — replaces raw unicode
// emoji/glyphs in UI chrome. 24px grid, stroke-based (currentColor), so
// icons inherit text color and stay crisp at any size. No icon-font or
// package dependency; unused icons tree-shake out of the bundle.
...
const PATHS: Record<IconName, ReactNode> = {
  ...
  crown: (
    <>
      <path d="m3 6 4.5 4L12 4l4.5 6L21 6l-2 12H5z" />
      <path d="M5 21h14" />
    </>
  ),
  download: (
  ...
  moon: (
    <>
      ...
      <path d="m19 4 .4.9.9.4-.9.4-.4.9-.4-.9-.9-.4.9-.4.4-.9Z" strokeWidth="1.2" fill="currentColor" />
    </>
  ),
  ...
  sparkle: (
    <path d="M9.94 15.5a2 2 0 0 0-1.44-1.44l-6.13-1.58a.5.5 0 0 1 0-.96L8.5 9.94a2 2 0 0 0 1.44-1.44l1.58-6.14a.5.5 0 0 1 .96 0l1.58 6.14a2 2 0 0 0 1.44 1.44l6.14 1.58a.5.5 0 0 1 0 .96l-6.14 1.58a2 2 0 0 0-1.44 1.44l-1.58 6.14a.5.5 0 0 1-.96 0z" />
  ),
  star: (
    <path d="m12 3 2.7 5.6 6.1.85-4.45 4.28 1.1 6.07L12 16.9l-5.45 2.9 1.1-6.07L3.2 9.45l6.1-.85z" />
  ),
  "star-solid": (
    <path
      d="m12 3 2.7 5.6 6.1.85-4.45 4.28 1.1 6.07L12 16.9l-5.45 2.9 1.1-6.07L3.2 9.45l6.1-.85z"
      fill="currentColor"
      stroke="none"
    />
  ),
...
export interface IconProps extends Omit<SVGProps<SVGSVGElement>, "children"> {
  name: IconName;
  /** Square size in px (default 16 — inline-with-text scale). */
  size?: number;
