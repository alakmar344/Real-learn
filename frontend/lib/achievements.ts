...
export const BADGES: Badge[] = [
  ...
  },
  {
    ...
    how: "Try out RealLearn in 5 of the 63 supported languages across your quizzes.",
    tier: "silver",
  ...
  },
  {
    ...
    how: "Complete quiz parts across 8 different languages.",
    tier: "gold",
  ...
  },
  {
    ...
    icon: "globe",
    title: "Omniglot",
    description: "Learn in all 63 supported languages.",
    how: "Complete at least one quiz part in every single language RealLearn supports (63 languages!).",
    tier: "legendary",
    progress: (s) => ratio(s.languagesUsed.length, 63),
    earned: (s) => s.languagesUsed.length >= 63,
  },
  {
    id: "deadeye",
    icon: "target",
