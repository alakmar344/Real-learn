  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: 13, color: "var(--text-tertiary)", marginBottom: 24 }}>
        Last updated: July 29, 2026 (version 2.6)
      </p>
      ...
      <section style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 14, color: "var(--text-secondary)" }}>
          ...
          recently been asked. RealLearn is intended for educational purposes only.
        </p>
      </section>
      ...
      <section style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 14, color: "var(--text-secondary)" }}>
          ...
          automatically falls back to <strong>Cloudflare Workers AI</strong> (Gemma) so the lesson
          can still be generated. All responses are <strong>not reviewed by humans before being shown</strong>.
          To keep the Service reliable, if the primary provider is temporarily slow or unavailable,
          the same request is automatically retried and may be routed to the fallback provider; the
          model and content characteristics are equivalent, and no human is involved in either path.
