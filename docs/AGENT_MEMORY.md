...
The big idea → How it works → Where you see it). Every part is readable
immediately — nothing is locked. Each part ends with an OPTIONAL 2-question
quick check; any score continues, and retrying missed questions is a choice. Lessons are generated by a unified
