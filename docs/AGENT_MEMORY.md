...
aesthetic is the **Evergreen** design language — calm surface, warm core:
deep emerald `#047857` (light) / soft mint `#34D399` (dark) as the ONE
interactive accent, a warm amber companion (`#B45309` / `#FBBF24`) reserved
for energy moments (streaks, sparks, celebration), green-tinted paper
`#F6F8F6` by day and forest-black ink `#0B100E` by night. Body text is
...
- 2026-07-28 — **RealLearn Brand DNA & Visual Ownability UI Redesign.**
