...
| 2026-07-26 | `desktop-overhaul` | Desktop UI Overhaul & Responsive Refinement: expanded hero stage (920px) and question input (880px), responsive spark ordering (top on mobile, under input on desktop), deduplicated brand header on desktop, removed redundant sidebar App Tour button, and fixed PartCard text container to 100% width on desktop. |
